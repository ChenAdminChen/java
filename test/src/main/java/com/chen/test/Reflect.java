...
public class Reflect {
    ...
    public static void Demo2() throws ClassNotFoundException {
        ...
        //定义两个类型都未知的Class，设置初值为null,看它们如何赋值给Person
        Class<?> class1 = null;
        Class<?> class2 = null;

        class1 = Class.forName("com.chen.test.Person");

        System.out.println("Demo2:(写法1)包名：" + class1.getPackage().getName() + "," + "完整类名:" + class1.getName());

        class2 = Person.class;
        System.out.println("Demo2:(写法2)包名：" + class1.getPackage().getName() + "," + "完整类名:" + class1.getName());
    ...
    public static void Demo3() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        person.setDescribe("he is boy");

        System.out.println("Demo3: " + person.getName() + " : " +person.getDescribe() +" : " + person.getDescribe());
    }
    ...
    public static void Demo4() throws ClassNotFoundException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        person1 = (Person) constructors[1].newInstance();
        person1.setDescribe("he is body");
        person1.setName("leeFeng");
        person1.setAge(30);

        person2 = (Person) constructors[0].newInstance("leefeng", 20, "he is body1");
    ...
    {
        Class<?> class1 = null;
        class1 = Class.forName("com.chen.test.SuperMan");
